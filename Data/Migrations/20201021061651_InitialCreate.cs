    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Calgary", 1392609, "AB" },
                    { 16, "Prince Albert", 32546, "SK" },
                    { 15, "Sherbrooke", 212105, "QC" },
                    { 14, "Quebec City", 798162, "QC" },
                    { 13, "Montreal", 4098927, "QC" },
                    { 12, "Toronto", 5928040, "ON" },
                    { 11, "Hamilton", 747545, "ON" },
                    { 10, "Ottawa", 934243, "ON" },
                    { 9, "Winnipeg", 778489, "MB" },
                    { 8, "Steinbach", 15829, "MB" },
                    { 7, "Brandon", 48859, "MB" },
                    { 6, "Victoria", 367770, "BC" },
                    { 5, "Vancouver", 2463431, "BC" },
                    { 4, "Kelowna", 127380, "BC" },
                    { 3, "Lethbridge", 117394, "AB" },
                    { 2, "Edmonton", 1321426, "AB" },
                    { 17, "Regina", 236481, "SK" },
                    { 18, "Saskatoon", 295095, "SK" }
                });
